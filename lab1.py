...
- points: 0
  ...
  expect: "1"
  note: "[Getppid]Failed to get ppid"
  name: "getppid"

- points: 15
  expect: "0"
  note: "[Getppid]Child process exit status is incorrect"
